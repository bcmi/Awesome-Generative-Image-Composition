...
+ Junjia Huang, Pengxiang Yan, Jiyang Liu, Jie Wu, Zhao Wang, Yitong Wang, Liang Lin, Guanbin Li: "*DreamFuse: Adaptive Image Fusion with Diffusion Transformer.*" ICCV (2025) (**+text**) [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Huang_DreamFuse_Adaptive_Image_Fusion_with_Diffusion_Transformer_ICCV_2025_paper.pdf) [[demo]](https://huggingface.co/spaces/LL3RD/DreamFuse) 
...
+ Daniel Winter, Asaf Shul, Matan Cohen, Dana Berman, Yael Pritch, Alex Rav-Acha, Yedid Hoshen: "*ObjectMate: A Recurrence Prior for Object Insertion and Subject-Driven Generation.*" ICCV (2025)  [[paper]](https://openaccess.thecvf.com/content/ICCV2025/papers/Winter_ObjectMate_A_Recurrence_Prior_for_Object_Insertion_and_Subject-Driven_Generation_ICCV_2025_paper.pdf)
